...
original_path = "I-HAZE/# I-HAZY NTIRE 2018/GT/"
training_path = "I-HAZE/# I-HAZY NTIRE 2018/hazy/"
...
for original_file in files:
    ...
    training_file=name_split+'_indoor_hazy.jpg'
    print(training_file)
    ...
    cv2.imwrite("op/ihaze-clear-"+str(count)+".png", clear_img)
    cv2.imwrite("op/ihaze-hazy-"+str(count)+".png", hazy_image)
    ...
    cv2.imwrite("op/ihaze-dcp-"+str(count)+".png", dcp_img*255)
    cv2.imwrite("op/ihaze-erc-"+str(count)+".png", erc_img*255)
    ...
    cv2.imwrite("op/ihaze-aod-"+str(count)+".png", res*255)
    ...
    cv2.imwrite("op/ihaze-dcp_aod-"+str(count)+".png", dcp_img*255)
    cv2.imwrite("op/ihaze-erc_aod-"+str(count)+".png", erc_img*255)
    ...
    cv2.imwrite("op/ihaze-aod_dcp-"+str(count)+".png", dcp_img*255)
    cv2.imwrite("op/ihaze-aod_erc-"+str(count)+".png", erc_img*255)
    ...
    cv2.imwrite("op/ihaze-erc_dcp-"+str(count)+".png", dcp_img*255)
    cv2.imwrite("op/ihaze-dcp_erc-"+str(count)+".png", erc_img*255)
    ...
    # cv2.imshow("dcp",cv2.resize(dcp_img, (640, 480)) )
    # cv2.imshow("hello",res1)
